...
public class LectorqrCustomizado extends View implements IViewFinder {
    ...
    private static final float LANDSCAPE_WIDTH_HEIGHT_RATIO = 1.8f;
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.transparent);
    ...
    public LectorqrCustomizado(Context context) {
        super(context);
        init();
    }

    public LectorqrCustomizado(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
